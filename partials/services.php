 ...
 *
 * @package WordPress
 * @subpackage preschooltheme
 * @since Pre School 1.1
 */
...
<section id="services" class="color-section">
    ...
    <!-- main text -->
            ...
            <div class="col-md-12 col-lg-5">
                <!-- Image -->
                <img src="<?=get_template_directory_uri()?>/assets/img/services.png" alt="" class="img-responsive center-block">
            </div>
            <!-- /col-md-12-->
        </div>
        <!-- /row -->
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <img src="<?=get_template_directory_uri()?>/assets/img/service1.jpg" alt="" class="img-circle center-block img-responsive">
                <h4>Infants</h4>
            ...
            <div class="col-md-4 col-sm-12 res-margin">
                <div class="service float">
                <img src="<?=get_template_directory_uri()?>/assets/img/service2.jpg" alt="" class="img-circle center-block  img-responsive">
                <h4>Toddlers</h4>
                <p>Lectus placerat a ultricies a,interdum donec eget metus auguen u Fusce mollis imperdiet interdum donec eget metus auguen unc vel lorem.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-12">
                <div class="service float">
                <img src="<?=get_template_directory_uri()?>/assets/img/service3.jpg" alt="" class="img-circle center-block img-responsive">
                <h4>Pre School</h4>
                <p>Lectus placerat a ultricies a, interdum donec eget metus auguen u Fusce mollis imperdiet interdum donec eget metus auguen unc vel lorem.</p>
                </div>
            </div>
