...
<footer>
   <div class="container-fluid">           
      ...
      <div class="col-lg-4 col-md-6 res-margin">
         <a href="#page-top"><img src="<?=get_template_directory_uri()?>/assets/img/logo.png"  alt="" class="center-block"></a>
         <!-- social-icons -->	
   ...
   <!-- / container -->
   <hr>
   <p>Copyright © 2016 - 2020 / Designed by  <a href="http://www.ingridkuhn.com">Ingrid Kuhn</a></p>
   <!-- /container -->
   <!-- Go To Top Link -->
